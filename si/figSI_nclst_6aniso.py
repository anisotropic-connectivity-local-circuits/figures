...
# with open(dpath+'nmotif_ecounts_dist_n6_S2500K.p', 'rb') as pfile:
#     dist_data = pickle.load(pfile)
# with open(dpath+'nmotif_ecounts_rew-dist_n6_S2500K.p', 'rb') as pfile:
...
#             color=color['dist'], label="dist.~depend.")
