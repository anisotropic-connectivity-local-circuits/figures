...
ax.plot(data['bin_vals'], data['out']['tuned']['mean'],
            color=color['tuned'], markersize=0, lw=2,
            zorder=-2, label='tuned', alpha=1)

ax.plot(data['bin_vals'], data['out']['rew_tuned']['mean'],
            color='grey', markersize=0, lw=2,
            zorder=-1, label='rewired', alpha=1, dashes=[3,5.5])

ax.plot(data['bin_vals'], data['out']['dist_tuned']['mean'],
