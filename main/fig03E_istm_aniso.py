...
c = 1./np.sum(data['aniso']['mean']*(data['centers'][2]-data['centers'][1]))
print (np.sum(data['aniso']['mean']*c*(data['centers'][2]-data['centers'][1])))
...
ax.plot(data['centers'], norm(data['aniso']['mean']),
            color=color['aniso'], markersize=0, lw=1.5,
            zorder=1, label='aniso.', alpha=1)

# ax.plot(data['centers'], data['rew025_aniso']['mean'],
#             color=color['rew'], markersize=0, lw=1.5,
#             zorder=-0, label='rewired', alpha=1)

# ax.plot(data['centers'], data['rew050_aniso']['mean'],
#             color=color['rew'], markersize=0, lw=1.5,
#             zorder=-0, label='rewired', alpha=1)

# ax.plot(data['centers'], data['rew075_aniso']['mean'],
#             color=color['rew'], markersize=0, lw=1.5,
#             zorder=-0, label='rewired', alpha=1)


ax.plot(data['centers'], norm(data['rew_aniso']['mean']),
            color=color['rew'], markersize=0, lw=2,
            zorder=-0, label='rewired', alpha=1)

# ax.plot(data['centers'], data['rew10_aniso']['mean'],
#             color='grey', markersize=0, lw=2,
#             zorder=-0, label='dist.~dep.', alpha=1)

ax.plot(data['centers'], norm(data['dist_aniso']['mean']),
            color=color['dist'], markersize=0, lw=2,
            zorder=-0, label='dist.~dep.', alpha=1)



# ax.plot(data['centers'], data['tuned']['mean'],
#             color=color['tuned'], markersize=0, lw=1.5,
#             zorder=1, label='tuned.', alpha=1)


# ax.plot(data['centers'], data['rew_tuned']['mean'],
#             color=color['rew'], markersize=0, lw=2,
#             zorder=-0, label='rewired', alpha=1)

# ax.plot(data['centers'], data['dist_tuned']['mean'],
#             color=color['dist'], markersize=0, lw=2,
#             zorder=-0, label='dist.~dep.', alpha=1)
